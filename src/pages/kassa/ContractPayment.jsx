...
const ContractPayment = () => {
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">Shartnomaga to'lov olish</h1>
      ...
      <div className="bg-white h-[500px] rounded-xl shadow-sm border border-gray-100 flex flex-col items-center justify-center text-center p-8">
        ...
        <p className="text-sm text-gray-500 max-w-md mt-2">
            Shartnomaga to'lov olish uchun, o'zingizga kerakli mijozni ID, FIO, telefon raqami va shartnoma IDsi orqali izlang!
        </p>
      </div>
    </div>
  );
