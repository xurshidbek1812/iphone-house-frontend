...
const CustomerIncome = () => {
  const data = [
    { id: '2231', org: "Qo'shko'pir filiali", contract: 'ID: 34332\n21.01.2026', client: 'NIYOZOV UMID TOJIBOYEVICH', product: 'Coat Katta Techno', qty: '1 Dona', amount: '356 000 UZS', user: 'Bekchanov Azomat', status: 'Tasdiqlandi' },
    { id: '2223', org: "Qo'shko'pir filiali", contract: 'ID: 34002\n14.01.2026', client: 'OTABOYEVA OYGUL QABUL QIZI', product: 'Smartfon Infinix Hot 30i 8/256 GB Sleek Black', qty: '1 Dona', amount: '2 204 900 UZS', user: 'Bekchanov Azomat', status: 'Tasdiqlandi' },
  ];

  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">Mijozdan tovar kirimi</h1>
        ...
        <table className="w-full text-left whitespace-nowrap">
          <thead className="bg-gray-50 text-xs font-semibold text-gray-500 uppercase">
            <tr>
              ...
              <th className="p-4">Mijoz F.I.O</th>
          ...
          <tbody className="divide-y divide-gray-100 text-sm">
            {data.map((item) => (
              <tr key={item.id} className="hover:bg-gray-50">
                ...
                <td className="p-4 text-blue-600 font-bold text-xs">{item.qty}</td>
