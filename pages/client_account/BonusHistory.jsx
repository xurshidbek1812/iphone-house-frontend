...
const BonusHistory = () => {
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">Bonus hisob raqami tarixi</h1>
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                  <div className="text-xs text-gray-500 mb-1">Bonus hisobi</div>
          ...
          <div className="relative">
             ...
             <div className="relative">
                <input type="text" placeholder="Mijozni qidirish..." className="w-full pl-4 pr-10 py-3 border rounded-lg outline-none focus:border-blue-500" />
