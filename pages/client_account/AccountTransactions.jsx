...
const AccountTransactions = () => {
  const data = [
    { id: '3524', date: '23.01.2026', client: 'AVEZOVA MASHHURA ERGASH QIZI', type: 'Mijozga pul qaytarish', amount: '200 000 UZS', status: 'Tasdiqlandi' },
    { id: '3520', date: '23.01.2026', client: 'AVEZOVA MASHHURA ERGASH QIZI', type: 'Grafik to\'lovni qaytarish', amount: '200 000 UZS', status: 'Tasdiqlandi' },
    { id: '3472', date: '19.01.2026', client: 'SABIROV SAPARBOY XXX', type: 'Shartnomaga to\'lov olish', amount: '17 400 UZS', status: 'Tasdiqlandi' },
  ];

  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-800">Hisob raqam amaliyotlari</h1>
